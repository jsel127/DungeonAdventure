...
/**
 * Test MonsterFactory class which creates different monsters. 
...
describe("Tests the monster factory and ensures a Monster object is properly created", () => { 
    ...
    test("Creating an invalid monster", () => {
        expect(() => MonsterFactory.createMonster("Priestess")).toThrow(ReferenceError);
    });

    test("Throws if class is instanciated", () => {
        expect(() => new MonsterFactory()).toThrow(EvalError);
    });
});